...
M.general = {
	n = {
		...
		["<leader>wf"] = { "<cmd> MoveWord(1) <CR>", "Move word forward" },
		["<leader>wb"] = { "<cmd> MoveWord(-1) <CR>", "Move word backward" },
		["<leader>xx"] = { "<cmd> TroubleToggle <CR>", "Toggle trouble list" },
		["<leader>xw"] = { "<cmd> TroubleToggle workspace_diagnostics <CR>", "Toggle workspace trouble list" },
		["<leader>xd"] = { "<cmd> TroubleToggle document_diagnostics <CR>", "Toggle document trouble list" },
		["<leader>xl"] = { "<cmd> TroubleToggle loclist <CR>", "Toggle location list trouble" },
		["<leader>xq"] = { "<cmd> TroubleToggle quickfix <CR>", "Toggle quickfix list trouble" },
		["gR"] = { "<cmd> TroubleToggle lsp_references <CR>", "Toggle lsp references list" },
	},
	v = {

		["<A-j>"] = { "<cmd> MoveBlock(1) <CR>", "Move highlighted block down" },
		["<A-k>"] = { "<cmd> MoveBlock(-1) <CR>", "Move highlighted block up" },
		["<A-h>"] = { "<cmd> MoveHBlock(-1) <CR>", "Move visual area left" },
		["<A-l>"] = { "<cmd> MoveHBlock(1) <CR>", "Move visual area right" },
	},
}
